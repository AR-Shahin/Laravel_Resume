                          ...
                          @endphp
                           @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->year}}</td>
                                <td>
                                    <a href="{{ url('work_update/'.base64_encode($d->id)) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                                    <a href="{{ url('work_delete/'.base64_encode($d->id)) }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure ?')">Delete</a>
